        ...
        bottomNavigationView.setOnItemSelectedListener(new NavigationBarView.OnItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemID == R.id.txtGteam){
                    Intent intent = new Intent(AssistantInternshipActivity.this, GTeamActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemID == R.id.txtSongster ){
                    Intent intent = new Intent(AssistantInternshipActivity.this, SongsterActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemID == R.id.txtAssInt){
                    Intent intent = new Intent(AssistantInternshipActivity.this, AssistantInternshipActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemID == R.id.btnSongsterNext){
