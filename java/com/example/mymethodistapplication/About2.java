    ...
    private void showPopupMenu(BottomNavigationView bottomNavView) {
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                {
                    Intent intent = new Intent(About2.this, DonationsActivity.class);
                ...
                {
                    Intent intent = new Intent(About2.this,CommunityChatActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Photos)
                {
                    Intent intent = new Intent(About2.this,Photos1.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Volunteer)
                {
                    Intent intent = new Intent(About2.this, VolunteerActivity.class);
                    startActivity(intent);
                    return true;
                }
                ...
                {
                    Intent intent = new Intent(About2.this, Account.class);
                    startActivity(intent);
                    return true;
                }
