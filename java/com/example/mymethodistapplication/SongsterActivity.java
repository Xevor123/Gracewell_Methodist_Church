        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                if (itemId == R.id.nav_Appointments) {
                    Intent intent = new Intent(SongsterActivity.this, AppointmentsActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Log_Out) {
                    ...
                    mAuth.signOut();
                    Intent intent = new Intent(SongsterActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
                ...
                if (itemId == R.id.nav_Photos) {
                    Intent intent = new Intent(SongsterActivity.this, Photos1.class);
                    startActivity(intent);
                    return true;
                }
                ...
                if (itemId == R.id.nav_About) {
                    Intent intent = new Intent(SongsterActivity.this, About1.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Account) {
                    Intent intent = new Intent(SongsterActivity.this, Account.class);
                    startActivity(intent);
                    return true;
                }
