    ...
    private void showPopupMenu(BottomNavigationView bottomNavView) {
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                {
                    Intent intent = new Intent(ChangePassword.this, DonationsActivity.class);
                ...
                {
                    Intent intent = new Intent(ChangePassword.this,CommunityChatActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Photos)
                {
                    Intent intent = new Intent(ChangePassword.this,Photos1.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Volunteer)
                {
                    Intent intent = new Intent(ChangePassword.this, VolunteerActivity.class);
                    startActivity(intent);
                    return true;
                }
