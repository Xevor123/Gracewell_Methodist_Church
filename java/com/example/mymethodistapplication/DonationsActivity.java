...
public class DonationsActivity extends AppCompatActivity {
    ...
    BottomNavigationView bottomNavigationView = findViewById(R.id.bottom_navigation);
        ...
        bottomNavigationView.setSelectedItemId(R.id.menu_nav);
    ...
    private void showPopupMenu(BottomNavigationView bottomNavView) {
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem menuItem) {
                ...
                {
                    Intent intent = new Intent(DonationsActivity.this, AppointmentsActivity.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Log_Out)
                {
                    ...
                    mAuth.signOut();
                    Intent intent = new Intent(DonationsActivity.this, MainActivity.class);
                    startActivity(intent);
                    finish();
                }
                ...
                {
                    Intent intent = new Intent(DonationsActivity.this,Photos1.class);
                    startActivity(intent);
                    return true;
                }
                ...
                {
                    Intent intent = new Intent(DonationsActivity.this, About1.class);
                    startActivity(intent);
                    return true;
                }
                if (itemId == R.id.nav_Account)
                {
                    Intent intent = new Intent(DonationsActivity.this, Account.class);
                    startActivity(intent);
                    return true;
                }
